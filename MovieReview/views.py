...
# print( context);
def home(request):
    return render(request, 'moviereview/home.html',{'result':context, 'genres':context_2, 'genre_id': 0})
...
def genre(request,id):
    ...
    context_3= json.load(response_1);
    return render(request, 'moviereview/home.html',{'result':context_3, 'genres':context_2, 'genre_id': id})